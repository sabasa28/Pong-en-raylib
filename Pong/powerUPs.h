...
extern const float pwrUPMinRespawnPosDivider;
extern const float pwrUPMaxRespawnPosDivider;
...
extern const int delayToRespawn;
extern const float powerUPTexOffsetXDivider;
extern const float powerUPTexOffsetYDivider;
namespace catPong{
	void initPowerUP();
	void initPowerUPTex();
}
