...
static enum ScreenSizeSelected {
	x800y450,
	x1200y675,
	fullscreen,
	none
};
static enum ColorSelected {
	Red,
	Green,
	Blue
};
...
const static float coloredbuttonsHeightDivider = 15.0f;
const static float coloredbuttonsWidthDivider = 8.0f;
const static float p1ColoredButtonsYDivider = 1.28571f;
const static float p2ColoredButtonsYDivider = 1.125f;
const static float redButtonsXDivider = 3.2f;
const static float greenButtonsXDivider = 2.285f;
const static float blueButtonsXDivider = 1.77778f;
const static float selectedButtonDifference = 45.0f; 
const static float playButtonXDivider = 4.44444f;
const static float playButtonYDivider = 3.75f;
const static float playButtonWidthDivider = 2.0f;
const static float playButtonHeightDivider = 4.5f;
const static float exitButtonXDivider = 3.47826f;
const static float exitButtonYDivider = 1.875f;
const static float exitButtonWidthDivider = 2.66667f;
const static float exitButtonHeightDivider = 5.625f;
const static float playTextXDivider = 2.66667f;
const static float playTextYDivider = 3.46154f;
const static float playTextFontDivider = 5.625f;
const static float exitTextXDivider = 2.42424f;
const static float exitTextYDivider = 1.73077f;
const static float exitTextFontDivider = 9.0f;
const static float colorSelecTextXDivider = 10.0f;
const static float colorSelecTextFontDivider = 12.85714f;
const static float vsBotButtonYDivider = 2.0f;
const static float vsBotButtonWidthDivider = 8.0f;
const static float vsBotButtonHeightDivider = 6.0f;
const static float vsPlayerButtonYDivider = 4.0f;
const static float vsPlayerButtonWidthDivider = 8.0f;
const static float vsPlayerButtonHeightDivider = 6.0f;
const static float gamemodeSelectedButtonXDivider = 800.0f;
const static float gamemodeNotSelectedButtonXDivider = -16.0f;
const static float vsPlayerTextXDivider = 790.0f;
const static float vsPlayerTextYDivider = 5.25f;
const static float vsBotTextXDivider = 790.0f;
const static float vsBotTextYDivider = 2.3f;
const static float gamemodeSelectFontSizeDivider = 20.0f;
const static float screenSizeButtonsWidthDivider = 8.0f;
const static float screenSizeButtonsHeightDivider = 7.0f;
const static float screenSizeSelectedButtonXDivider = 1.14f;
const static float screenSizeNotSelectedButtonXDivider = 1.05f;
const static float screenSize1ButtonYDivider = 6.0f;
const static float screenSize2ButtonYDivider = 2.5f;
const static float screenSize3ButtonYDivider = 1.55f;
const static float screenSizeTextFontSizeDivider = 20.0f;
const static float screenSizeTextXDivider = 1.2f;
const static float screenSize1TextYDivider = 10.0f;
const static float screenSize2TextYDivider = 3.0f;
const static float screenSize3TextYDivider = 1.75;
